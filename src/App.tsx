...
function App() {
  ...
  if (currentUser && !franchiseData) {
    return <FranchiseLogin onLoginSuccess={() => window.location.reload()} />;
  }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img src="/brainworx-logo.png" alt="Brainworx" className="h-16 w-auto" />
            </div>
              ...
              <div className="relative">
                <div className="relative z-10">
                  <img
                    ...
                    className="w-full max-w-lg mx-auto drop-shadow-2xl animate-pulse-slow"
                  />
                </div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-2xl md:text-3xl text-white font-semibold mb-4">
                For only R1500, you get the Assessment + 45min debrief, sign up!
              </p>
            </div>
              ...
              <div className="relative px-8 md:px-16 py-12 md:py-16">
                <div className="max-w-3xl">
                  ...
                  <div className="space-y-2">
                    <p className="text-xl md:text-2xl text-orange-400 font-bold">André Malraux</p>
                    <p className="text-lg text-gray-300 italic">French Novelist, Art & Cultural Theorist</p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src="/brainworx-logo.png" alt="Brainworx" className="h-12 w-auto" />
              </div>
      ...
      {showSelfAssessments && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-white">
          <SelfAssessmentsPage onClose={() => setShowSelfAssessments(false)} />
        </div>
      )}
