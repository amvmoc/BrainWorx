...
const questions: Question[] = [
  ...
  // SECTION R – RIASEC CAREER INTERESTS
...
const sectionTitles: Record<SectionId, string> = {
  ...
  C: "Section C – Values",
  D: "Section D – Strengths / Abilities (Self-view)",
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 relative my-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for completing the Teen Career Direction Assessment.
            </p>
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full relative my-8">
        ...
        <div className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white p-8 rounded-t-2xl">
          <h1 className="text-3xl font-bold mb-2">Teen Career Direction Assessment</h1>
          <p className="text-white/90">NIP + RIASEC Profile</p>
        </div>
        ...
        <div className="px-8 py-4 bg-blue-50 border-b border-blue-100">
          <p className="text-sm text-blue-800">
            {currentSection === "R"
              ? "For RIASEC questions: Yes = 2, Maybe = 1, No = 0"
        ...
        <div className="p-8 max-h-[50vh] overflow-y-auto">
          <div className="space-y-6">
            {sectionQuestions.map((q) => {
              ...
              const values = isRiaSec ? [2, 1, 0] : [1, 2, 3, 4, 5];
              const labels = isRiaSec ? ["Yes", "Maybe", "No"] : ["1", "2", "3", "4", "5"];
