      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Next Step: Invite a Caregiver
          </h3>
          <p className="text-gray-700 mb-6">
            To get a comprehensive view of {childName}'s behaviors, we need input from both home and school/care settings.
            Please provide the contact information for a teacher, therapist, or other caregiver who interacts with {childName} regularly.
          </p>
          <button
            onClick={() => setStage('invite_caregiver')}
            className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold"
          >
            Continue to Invite Caregiver
          </button>
        </div>
      </div>
    );
